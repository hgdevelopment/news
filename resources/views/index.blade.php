...
<head>
    ...
    <!-- Morris Charts CSS -->
    <link href="{{URL::asset('lib/morrisjs/morris.css')}}../vendor/morrisjs/morris.css" rel="stylesheet">
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    ...
                    <div class="panel-body">
                        <form role="form" class="form-horizontal form-material" id="loginform" method="post" action="{{ route('login') }}" >
                        {!! csrf_field() !!}
                            <fieldset>
